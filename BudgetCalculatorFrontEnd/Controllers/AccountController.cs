...
using static BudgetCalculatorFrontEnd.Models.AccountViewModel;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model)
        {
            ...
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                ...
                var cookie = new HttpCookie("MyCookie", info.AccessToken);
                var userCookie = new HttpCookie("UserName", info.UserName);
            ...
            else if (response.StatusCode == System.Net.HttpStatusCode.BadRequest)
            {
                ...
                var error = JsonConvert.DeserializeObject<AuthorizeError>(data);
